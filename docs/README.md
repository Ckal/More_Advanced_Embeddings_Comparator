...
- URL: https://huggingface.co/spaces/Chris4K/More_Advanced_Embeddings_Comparator
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/More_Advanced_Embeddings_Comparator/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/More_Advanced_Embeddings_Comparator
